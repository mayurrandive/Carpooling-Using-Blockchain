...
<table>
  ...
  <button className='ridebtn' onClick={handleCreateRide} style={{ backgroundColor: "var(--col-1)", color: "white", padding: "1vh", borderRadius: "10px",marginTop:"5vh", fontWeight:"700", fontSize:"large" }}
