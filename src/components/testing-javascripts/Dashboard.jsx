...
// ..
  ...
  <button className='i-know-this-class-of-buttons-doesnt-exist'><Link style={{color:'var(--col-1)'}}to={`/myinprogressrides/${passengerID}`} className="CurrentRide">
    <FaCar style={{marginRight:"0.5vw", transform:"scale(1.25)"}} />Current Ride
  </Link></button>
  <button className='i-know-this-class-of-buttons-doesnt-exist' ><Link style={{color:'var(--col-1)'}} to={`/ridehistory/${passengerID}`} className="History">
    <FaHistory style={{marginRight:"0.5vw", transform:"scale(1.25)"}} />History
  </Link></button>
  <button className='i-know-this-class-of-buttons-doesnt-exist'><Link style={{color:'var(--col-1)'}} to={`/enterRideInbox/${passengerID}`} className="Inbox">
    <FaEnvelope style={{marginRight:"0.5vw", transform:"scale(1.25)"}} />Inbox
  </Link></button>
  <button className='i-know-this-class-of-buttons-doesnt-exist'><Link style={{color:'var(--col-1)'}}to={`/viewallrides/${passengerID}`} className="CheckRides">
    <FaCar style={{marginRight:"0.5vw", transform:"scale(1.25)"}} />Check Rides
  </Link></button>
  <button className='i-know-this-class-of-buttons-doesnt-exist' ><Link  style={{color:'var(--col-1)'}} to={`/startaride/${passengerID}`} className="StartRide">
...
<Modal style={{marginTop:"15vh"}} show={showPFPModal} onHide={() => setShowPFPModal(false)}>
  ...
  style={{
    background: 'linear-gradient(-45deg, var(--col-1) 10%, transparent 10%, transparent 20%, var(--col-1) 20%, var(--col-1) 30%, transparent 30%, transparent 40%, var(--col-1) 40%, var(--col-1) 50%, transparent 50%, transparent 60%, var(--col-1) 60%, var(--col-1) 70%, transparent 70%, transparent 80%, var(--col-1) 80%, var(--col-1) 90%, transparent 90%, transparent)',
...
<button style={{alignSelf:'center',justifyContent:'center',backgroundColor:"var(--col-1)",color:"#FEFEFA",padding:'1vh',marginRight:"1vw",borderRadius:"5px",fontWeight:'700',fontSize:"large"}} onClick={() => handleRotate('left')}><LuRotateCcw style={{fontWeight:'700'}}/> Rotate Left</button>
          <button style={{alignSelf:'center',justifyContent:'center',backgroundColor:"var(--col-1)",color:"#FEFEFA",padding:'1vh',borderRadius:"5px",fontWeight:'700',fontSize:"large"}} onClick={() => handleRotate('right')}><LuRotateCw style={{fontWeight:"700"}}/> Rotate Right</button>
</div>
