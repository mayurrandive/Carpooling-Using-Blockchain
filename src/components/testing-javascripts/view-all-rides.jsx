           ...
           <div style={{backgroundColor:"#FEFEFA", width:"96vw",marginLeft:"1vw", height:"8vh", marginBottom:"2vh",display:"flex",flexDirection:"row"}}>
             ...
             <div style={{width:"30vw", display:"flex", flexDirection:"row",marginTop:"2vh", marginLeft:"-10vw"}}>
              {!(ride.HostID==passengerID) && (
                <button style={{backgroundColor:"var(--col-1)",fontWeight:"700",fontSize:"large", color:"white", marginLeft:"8vw", marginRight:"-6vw", marginTop:"-1vh", height:"6vh", width:"20vw"}} onClick={() => handleBookRide(ride.RideID)}>{(ride.PeersID.includes(passengerID))?"Booked":"Book Ride"}</button>
              )}
               <button style={{backgroundColor:"var(--col-1)",fontWeight:"700",fontSize:"large", color:"white", marginLeft:"8vw", marginRight:"-6vw", marginTop:"-1vh", height:"6vh", width:"20vw", marginRight:"-9vw"}}>View Ride Details</button>
              </div>
