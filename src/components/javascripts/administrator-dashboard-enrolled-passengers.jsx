...
function AdministratorDashboardPassengers() {
  ...
  const getVehicleURL = async (passreqid) => {
    const [CID, filename] =
      passengers[passreqid - 1].PassVehicleDetailsHash.split(";");
    ...
    <div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <li className="not-logo">
                <button
                  onClick={handleClick1}
                  className="administrator-dashboard-requests-navbar-buttons"
                  style={{
                    transition: "0.3s ease-in",
                    borderBottom: clicked1 ? "4px solid var(--col-1)" : "none",
                  }}
                >
                  <Link
                    style={{ color: "var(--col-1)" }}
                    to={`/passenger-requests`}
                    className="passenger-requests"
                  >
                    Request Records
                  </Link>
                </button>
              ...
              <li className="not-logo">
                <button
                  ...
                  style={{
                    transition: "0.3s ease-in",
                    borderBottom: clicked2 ? "4px solid var(--col-1)" : "none",
                  }}
                >
                  <Link
                    style={{ color: "var(--col-1)" }}
                    to={`/enrolled-passengers`}
                    className="enrolled-passengers"
                  >
                    Enrolled Passengers
                  </Link>
                </button>
              ...
              <li className="not-logo">
                <button
                  ...
                  style={{
                    transition: "0.3s ease-in",
                    borderBottom: clicked3 ? "4px solid var(--col-1)" : "none",
                  }}
                >
                  Inbox
                </button>
              ...
              <li className="not-logo">
                <button
                  ...
                  style={{
                    transition: "0.3s ease-in",
                    borderBottom: clicked4 ? "4px solid var(--col-1)" : "none",
                  }}
                >
                  <Link
                    style={{ color: "var(--col-1)" }}
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
                ...
                >
                  <tbody>
                    {passengers.map((request) => (
                      ...
                      >
                        <td style={{ width: "30vw", paddingLeft: "1vw" }}>
                          <b>Passenger ID:</b> {request.PassID}
                        </td>

                        <td style={{ width: "17vw" }}>
                          <button
                            onClick={() => {
                              setSlectedPassID(request.PassID);
            ...
            >
              {showPassengerDetails && (
                ...
                >
                  ...
                  <table>
                    <tbody>
                      <tr style={{ height: "1vh" }}>
                        ...
                        >
                          {passengers[selectedPassID - 1].PassName}
                        </td>
                      </tr>
                      <tr style={{ height: "1vh" }}>
                        <td
                        ...
                        >
                          {passengers[selectedPassID - 1].PassEMail}
                        </td>
                      </tr>
                      <tr style={{ height: "1vh" }}>
                        <td
                        ...
                        >
                          {passengers[selectedPassID - 1].PassWalletAddress}
                        </td>
                      </tr>
                      <tr style={{ height: "1vh" }}>
                        <td
                        ...
                        >
                          {passengers[selectedPassID - 1].PassHomeAddress}
                        </td>
                      </tr>
                      <tr style={{ height: "1vh" }}>
                        <td
                        ...
                        >
                          {passengers[selectedPassID - 1].PassGender}
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  {!(
                    ...
                    <h3 style={{ fontWeight: "700", fontSize: "larger" }}>
                      Vehicle Details
                    </h3>
                  )}
                  ...
                  {!(
                    ...
                    <table style={{ width: "50vw" }}>
                      <tbody>
                        <tr style={{ height: "1vh" }}>
                          <td style={{ width: "16vw", paddingLeft: "2vh" }}>
                            <b>Vehicle Type and</b> <br></br> <b>Name</b>
                          </td>
                          <td style={{ width: "16vw", paddingLeft: "2vh" }}>
                            <b>Vehicle Number</b> <br></br> <b>Plate</b>
                          </td>
                          <td style={{ width: "16vw", paddingLeft: "2vh" }}>
                            <b>Vehicle</b> <br></br> <b>Papers</b>
                          </td>
                        </tr>
                        <tr style={{ height: "1vh" }}>
                          <td
                          ...
                          >
                            <button
                              disabled={
                                !passengers[selectedPassID - 1]
                                  .PassVehicleDetailsHash
                              }
                              onClick={(event) => {
              ...
              {!showPassengerDetails && (
                <div style={{ paddingTop: "35vh", textAlign: "center" }}>
                  No passenger log selected yet.
                </div>
              )}
            </div>
          </div>
      ...
      <Modal show={!roleAdmin} size="lg" centered>
        ...
        <Modal.Body style={{ textAlign: "center" }}>
          <p>
            You do not have access to this page. Please switch to an
            administrator account in order to view this page and proceed
            further.
          </p>
        </Modal.Body>
      </Modal>
