         ...
         <div style={{display:"flex", flexDirection:"row"}}>
             ...
             <div style={{ alignSelf:"center",marginTop:"2vh", marginLeft:"1vh", marginRight:"1vh", marginBottom:"1vh",width:"44vw", height:"76vh", position:"sticky", overflowY:"scroll", overflowX:"hidden"}}>
               ...
               {passengers.map((request) => (
                 <tr key={request.PassID} style={{height:"10vh", border:"solid 1px black"}}>
                   ...
                   <td style={{width:"17vw"}}><button onClick={() => {setSlectedPassID(request.PassID);handleViewPassengerDetails();}} style={{width:"17vw",backgroundColor:"var(--col-1)",color:"#FEFEFA",padding:'1vh', marginLeft:"-3vw"}} ><b>View Passenger Details</b></button></td>
                 </tr>
                 ))}
           ...
           <div style={{border:"1px black solid",marginLeft:"2vw", width:"46vw", maxHeight:"80vh",height:"80vh", marginRight:"2vw"}}>
             ...
             <div style={{display:'flex',flexDirection:'column',alignSelf:'center'}}>
                ...
                <button onClick={handleHidePassengerDetails} style={{backgroundColor:"transparent",fontSize:"larger",border:"2px solid #000000",color:"var(--col-1)",marginTop:'0vh',fontWeight:'700',padding:"0.5vh",width:"14vw",textAlign:'center',alignSelf:'center'}}>Close Details Pane</button>
                </div>
