          ...
          <td style={{ backgroundColor: "#FEFEFA", paddingLeft: "2vh", borderBottom: 'solid 1px black' }}>
            <div style={{ display: 'flex', flexDirection: 'row' }}>
              ...
              <div style={{ paddingTop: "7vh", paddingLeft: "1vw" }}>
                <button className="ridebutton" style={{ width: '10vw', height: "5vh", alignSelf: "center", padding: "1vh", backgroundColor: "var(--col-1)", color: "white", fontWeight: "700", marginRight: "1vw" }} onClick={() => {
