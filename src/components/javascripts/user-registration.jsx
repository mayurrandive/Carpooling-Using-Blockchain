            ...
            <Carousel.Item >
              ...
              <tbody>
                <tr style={{height:"15vh"}}>
                  <td><label style={{paddingLeft:'1vw',fontSize:'18px',fontWeight:'700',width:'15vw',color:"var(--col-1)"}}>What's your Name?</label></td>
                ...
                <tr style={{height:"15vh", padding:"5vh"}}>
                  <td><label style={{paddingLeft:'1vw',fontSize:'18px',fontWeight:'700',width:'15vw',color:"var(--col-1)"}}>Where do you stay?</label></td>
                ...
                <tr style={{height:"15vh", padding:"5vh"}}>
                  <td><label style={{paddingLeft:'1vw',fontSize:'18px',fontWeight:'700',width:'15vw',color:"var(--col-1)"}}>What's your EMail?</label></td>
                ...
                <tr style={{height:"15vh", padding:"5vh"}}>
                  <td><label style={{paddingLeft:'1vw',fontSize:'18px',fontWeight:'700',width:'15vw',color:"var(--col-1)"}}>What's your Gender?</label></td>
        ...
        <Modal.Footer>
          <button onClick={handleCloseModal} style={{backgroundColor:"#14C38E",padding:'1vh',color:'#FEFEFA',fontWeight:'700',borderRadius:"10px"}}>
            ...
            <table style={{marginTop:'3vh'}}>
              <tbody>
              <tr style={{height:"15vh", padding:"5vh"}}>
                  <td><label style={{paddingLeft:'1vw',fontSize:'18px',fontWeight:'700',color:'var(--col-1)'}}>Vehicle Name and Type:</label></td>            
              ...
              <tr style={{height:"15vh", padding:"5vh"}}>
                  <td><label style={{paddingLeft:'1vw',fontSize:'18px',fontWeight:'700',color:"var(--col-1)"}}>Vehicle Number:</label></td>            
      ...
      <div style={{ display: "flex", flexDirection: "column", alignSelf: "center" }}>
        ...
        {vehicleDetailsHash && (
          <div style={{ alignSelf: "center" }}>
            ...
            <Carousel.Item>
            <div style={{backgroundColor:" #FEFEFA", display:"flex", flexDirection:"column", height:"65vh", margin:"1vw"}}>
            <h5 style={{fontWeight:"700",paddingTop:"1vh", textDecoration:"underline",color:'var(--col-1)',textAlign:'center'}}>Last Step: Some Points to Note Down</h5>
            ...
            <h5 style={{fontWeight:"700", paddingTop:"1vh", textDecoration:"none",color:'var(--col-1)',textAlign:'center',marginTop:"-2vh"}}>2.Acknowledgment</h5>
